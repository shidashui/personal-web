...
from sites.models.user import User
from sites.extensions import db
from sites.emails import send_confirm_email, send_reset_password_email
from sites.forms.auth import RegisterForm, LoginForm, ForgetPasswordForm, ResetPasswordForm
from sites.settings import Operations
from sites.utils import generate_token, validate_token, redirect_back
